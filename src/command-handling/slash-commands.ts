...
const clearCommand = new SlashCommandBuilder() // /clear (queue_name) (all)
  ...
  .addChannelOption(option =>
    option.setName('queue_name').setDescription('The queue to clear').setRequired(true)
  );
...
const cleanupQueue = new SlashCommandBuilder()
  ...
  .addChannelOption(option =>
    option.setName('queue_name').setDescription('The queue to clean').setRequired(true)
  );
